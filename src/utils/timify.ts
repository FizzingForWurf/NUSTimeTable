...
/**
 * Given an array of lessons, calculate the earliest and latest timings based on the lesson timings.
 * This bounds will then be used to decide the starting and ending hours of the timetable.
 * @param lessons
 * @param period
 * @returns `startingIndex`, `endingIndex`
 */
export function calculateStartAndEndOfDayTimings(
  lessons: Lesson[],
  period?: TimePeriod
